...
<div class="content">
    ...
    <div class="breadcrumb">
        <ul>
            ...
            <li><a href="#" class="is-active"> نظرات</a></li>
        </ul>
    </div>
                ...
                <tbody>
                    ...
                    ?>
                        <tr role="row">
                            ...
                            <td> <?= limit_words($item["message"], 20);  ?> </td>
                            <td> <?= unixtimestamp_to_shamsi($item["time"], "hh-mm-ss | YYYY-MM-dd") ?> </td>
                            <td class="text-success">تاییده شده (<?= $item["id"] ?>) </td>
                            <td>
                                <a href="/admin/dashboard/Comments/<?= $item["id"] ?>" class="item-delete mlg-15" title="حذف" onclick="return confirm('آیا نظر حذف شود  ؟ ');"></a>
